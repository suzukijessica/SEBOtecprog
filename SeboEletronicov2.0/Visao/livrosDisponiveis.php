...
<head>	
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <link rel="stylesheet" href="http://localhost/SEBOtecprog/SeboEletronicov2.0/Visao/css/MeusLivrosStyle.css" type="text/css" media="all">
  ...
  <?php  foreach($listOfBooks as $chave => $valor){ 
                ...
                <tr> 
                    <td>
                        <h2> Título: </h2> 
                         <h6>
                             <a href="http://localhost/SEBOtecprog/SeboEletronicov2.0/Visao/detalhesLivro.php?id_livro=<?php echo $valor['id_livro'] ?>"> <?php echo $valor['titulo_livro'] ?></a>
                         </h6>
                    </td>
                </tr>
      <?php }?>         
